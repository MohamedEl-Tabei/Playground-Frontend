...
const Logo = () => {
  return (
    <h1>
      <Link style={{ textDecoration: "none" ,transform:"scale(.7)"}} className="color-main mobile-logo" to={`/`}>
        <div className="d-flex aic jcb" style={{ border: "2px #f68840  solid", borderLeft:"none",borderBottom:"none",borderRadius:"0px 20px 0px 0px",}}>
          <img
